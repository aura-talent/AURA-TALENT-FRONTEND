...
export default function JobsPage() {
  ...
  return (
    <div className="employer-page">
      <div className="employer-page-head"><div><p className="eyebrow">Content and distribution</p><h1>Job listings</h1><p>Create clear roles, configure scoring priorities, and track conversion from view to interview.</p></div><Link className="btn btn-primary" href="/employer/jobs/new">＋ Create job</Link></div>
